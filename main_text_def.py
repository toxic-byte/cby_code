# =====================
# 每次运行注意修改数据集和esm向量保存的路径,nlp_embed_path
# =====================
import os
...
if __name__ == "__main__":
    ...
    for key in label_space.keys():
        ...
        train_nlp_cache = os.path.join(cache_dir, f"train_nlp_embeddings_{key}_def.pkl")
        ...
        assert len(test_esm_embeddings) == len(test_nlp) == len(test_id), "Test data alignment error!"
